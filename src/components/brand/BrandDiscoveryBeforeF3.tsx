    ...
    return (
        <section className="overflow-hidden rounded-[2rem] border border-gray-100 bg-white shadow-sm">
            <div className="border-b border-gray-100 px-5 pb-5 pt-5">
                ...
                <button
                    type="button"
                    onClick={() => onSelectGeneralPayment()}
                    className="mt-3 flex min-h-12 w-full items-center justify-between gap-3 rounded-2xl border border-blue-100 bg-blue-50 px-4 text-left transition hover:border-blue-200 hover:bg-blue-100 active:scale-[0.99]"
                >
                    <span className="flex min-w-0 items-center gap-3">
                        ...
                        <span className="min-w-0">
                            ...
                            <span className="block text-[10px] font-bold text-blue-700/70">
                                브랜드가 없어도 일반 카드 혜택을 비교해요
                            </span>
                        </span>
                    </span>
                    <span className="shrink-0 text-[10px] font-black text-blue-600">바로 가기</span>
                </button>
                <div
                    role="tablist"
                    ...
                    {searchResults.length > 0 ? (
                        ...
                        <div className="rounded-2xl border border-dashed border-gray-200 bg-gray-50 px-4 py-10 text-center">
                            ...
                            <p className="mt-1 text-[11px] text-gray-400">
                                다시 검색하거나 일반 결제로 카드 혜택을 비교해보세요.
                            </p>
                            <button
                                type="button"
                                onClick={() => onSelectGeneralPayment(searchQuery)}
                                className="mt-4 min-h-11 w-full rounded-2xl bg-blue-600 px-4 text-xs font-black text-white shadow-sm transition hover:bg-blue-700 active:scale-[0.98]"
                            >
                                &lsquo;{searchQuery.trim()}&rsquo; 일반 결제로 추천받기
                            </button>
                            <button
                                type="button"
                                onClick={() => {
                                ...
                                className="mt-2 min-h-11 w-full rounded-2xl bg-white px-4 text-xs font-black text-gray-600 transition hover:bg-gray-100"
                            >
                                검색어 지우고 다시 찾기
                            </button>
                        </div>
